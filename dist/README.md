...
|大姨妈|1|<li>全屏广告-弹窗广告|
|大众点评|7|<li>全屏广告-主页推荐关注弹窗<li>权限提示-通知权限<li>局部广告-关闭[签到开红包]<li>全屏广告-弹窗广告<li>分段广告-推荐页卡片广告<li>功能类-选择地图时自动点击[更多]<li>权限提示-首页横幅索取位置|
|呆萌价|1|<li>开屏广告|
...
|番喜视频|1|<li>全屏广告|
|返利|1|<li>全屏广告-弹窗广告|
|飞常准业内版|2|<li>分段广告-关闭应用内广告<li>开屏广告-跳过开屏广告|
|飞客|1|<li>全屏广告-弹窗广告|
|飞猫管家|1|<li>开屏广告|
...
|美团|11|<li>更新提示<li>全屏广告-弹窗广告<li>评价提示-订单调查弹窗<li>局部广告-悬浮广告<li>权限提示-定位权限<li>权限提示-通知权限<li>全屏广告-新人返场特惠<li>全屏广告-视频页弹窗广告<li>功能类-付款后自动点击完成<li>局部广告-直播讲解悬浮窗<li>权限提示-消息页打开通知提醒|
...
|少年梦阅读|1|<li>开屏广告|
|设备信息|5|<li>分段广告-卡片广告(旧版)<li>分段广告-卡片广告<li>通知提示-开通会员提醒<li>局部广告-评价提醒<li>全屏广告-下载应用|
